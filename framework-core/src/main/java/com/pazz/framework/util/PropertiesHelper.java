...
import com.pazz.framework.util.string.StringTokenizerUtils;
...
/**
 * @author: 彭坚
 * @create: 2018/11/19 15:54
 * @description: Properties的操作的工具类, 为Properties提供一个代理增加相关工具方法如 getRequiredString(),getInt(),getBoolean()等方法
...
public class PropertiesHelper {
    ...
    public PropertiesHelper(java.util.Properties p) {
        setProperties(p);
    }

    public PropertiesHelper(java.util.Properties p, int systemPropertiesMode) {
        setProperties(p);
